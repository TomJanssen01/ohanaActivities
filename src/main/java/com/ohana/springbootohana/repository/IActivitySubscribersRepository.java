...
public interface IActivitySubscribersRepository extends JpaRepository<ActivitySubscribers, Long> {
    @Query("select " +
    ...
    List<ISubscriptionItem> findAllSubscribtionsOfUser(@Param("userId") Long userId);
}
